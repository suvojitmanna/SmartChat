...
const Message = ({ message }) => {
  ...
  // Typing Animation (assistant only)
  useEffect(() => {
    ...
    {message.role === "user" ? (
      ...
      <div className="flex items-start justify-end my-4 gap-3 group">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-800 dark:text-gray-100 leading-relaxed break-words">
            {message.content}
          </p>
        ...
        <img
          ...
          shadow-md border border-indigo-300/50
          dark:border-purple-500/50 object-cover flex-shrink-0"
        />
      </div>
